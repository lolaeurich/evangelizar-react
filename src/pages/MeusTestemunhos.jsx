...
import testemunho from "../assets/Testemunhos/testemunho.png"
import chat from "../assets/areaLogada/chat.png"
import FormularioTestemunho from "../components/testemunhos/formulario/formularioTestemunho";
import ListaTestemunhos from "../components/testemunhos/listTestemunhos/listTestemunhos.jsx"
// import "../components/testemunhos/"
      ...
      <div className="nav">
          ...
          <div className="dropdown">
            ...
            <div className="testemunho-banner">
                <img alt="" className="testemunho-amarelo" src={testemunho}/>
                <div className="testemunho-text">
                    <h3 className="testemunho-h3">Meus testemunhos</h3>
                    <p className="testemunho-p">Veja seus testemunhos e adicione novos</p>
                </div>
            </div>
